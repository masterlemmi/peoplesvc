package com.lemmi.tools.people._interviews.algorithms.graph.djikstra;
    ...
    public static void main(String[] args) {
        ...
        while (!unvisited.isEmpty()) {
            ...
            for (Node node : adjacentNodeMap.keySet()) {
                ...
                int parentsDistanceToSrc = closestNode.getDistanceToSource();
                int lweight = adjacentNodeMap.get(node);
                int newDistToSrc = parentsDistanceToSrc + lweight;
