...
public class RelationshipService {
    ...
    @Transactional
    List<Relationship> getRelationashipsTest(int id) {
        List<Relationship> list = relRepo.findByPersonId(id);
    ...
    public List<RelationshipDTO> getRelationships(int id) {
        List<Relationship> rels = relRepo.findByPersonId(id);
    ...
    public RelationshipDTO getRelationships(int personId, @NonNull String labelOfInterest) {
        List<Relationship> rels = relRepo.findByPersonId(personId);
        Map<String, Set<SimplePersonDTO>> map = new HashMap<>();
        for (Relationship rel : rels) {
